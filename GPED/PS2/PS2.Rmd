...
DiD estimation can be formulated in different ways: table form and regression form. 

* Table form is more intuitive and straightforward. But it does not work in some more complicated settings such as adding baseline covariates and fixed effects. Furthermore, we cannot use statistical tests and control for other covariates.
* Regression form is less straightforward but more powerful. It allows for statistical tests and fixed effects.
